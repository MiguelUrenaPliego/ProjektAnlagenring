...
\section{Durchgängigkeit}

Der Begriff Durchgängigkeit beschreibt, ob ein öffentlicher Freiraum von Menschen als ein zusammenhängendes, kontinuierlich erlebbares Ganzes wahrgenommen wird und nicht als eine Abfolge isolierter Teilstücke. Jane Jacobs argumentierte in ihrer einflussreichen Stadtplanungskritik, dass die Qualität eines Parks nicht allein von der Gestaltung einzelner Abschnitte abhängt, sondern maßgeblich davon, ob durchgehende, sichere und belebte Wegeverbindungen ihn mit seiner Umgebung verknüpfen \autocite{jacobs1961}. Ein guter Park entsteht laut Jacobs erst durch diese Anbindung an die Umgebung. Belebte, überschaubare Ränder und Zugänge sorgen für soziale Kontrolle (\enquote{eyes on the street}) und laden zum Durchqueren ein, während unterbrochene oder unattraktive Übergänge Angsträume erzeugen und den Freiraum in voneinander isolierte Fragmente zerfallen lassen. Jacobs betonte außerdem, dass ein Park nur dann dauerhaft belebt und sicher ist, wenn er unterschiedliche Nutzendengruppen mit unterschiedlichen Aktivitäten anzieht. Ein Park, der nur eine einzige Zielgruppe oder Aktivität bedient, ist lediglich zu bestimmten Tageszeiten belebt und bleibt in der übrigen Zeit unbeobachtet und unsicher. Erst ein Nebeneinander verschiedener, auf unterschiedliche Gruppen zugeschnittener Angebote sorgt für eine kontinuierliche Nutzung über den Tag hinweg, etwa für Kinder am Nachmittag, Berufstätige in der Mittagspause und Anwohnende am Abend. Übertragen auf den Anlagenring bedeutet Durchgängigkeit somit, dass hohe Aufenthaltsqualität an einzelnen Orten nur dann wirksam wird, wenn auch die Verbindungen zwischen ihnen als sicher und einladend wahrgenommen werden. Das betrifft vor allem Kreuzungen und Übergänge.
